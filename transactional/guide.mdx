...
To send Transactional email, you will need to use our [API](https://www.notion.so/5b453a52dd7c4b419aa4647410de9770) (with more support for third-party integrations coming soon). Requests need to be authenticated using an API key as described [here](https://www.notion.so/5b453a52dd7c4b419aa4647410de9770).

### Sending your first transactional email

To get started, click “Create” followed by “Transactional”.

<iframe src="https://res.cloudinary.com/mintlify/video/upload/v1684192725/transactional_f2wntg.mp4">
  {" "}
</iframe>
...
<iframe src="https://res.cloudinary.com/mintlify/video/upload/v1684193741/view-payload_yasybs.mp4">
  {" "}
</iframe>
