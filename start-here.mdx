---
title: 'Start Here'
description: 'Welcome to Loops, the platform for SaaS email.'
---
...
Before you can start sending emails with Loops, you need to set up your domain records. You can read this guide to [Setting up a domain for sending with Loops](/deliverability/setting-domain) or figure it out yourself :)
...
You can always send the records to a developer to help you integrate them. Here’s how: [Adding a member to your team](/account/adding-team-member)
...
Loops are emails triggered by a contact joining your list, an update made to the contact’s property or an event sent via [API](/add-users/api-reference) or [Integrations](/add-users/integrations). These are often known as “Lifecycle” emails.
