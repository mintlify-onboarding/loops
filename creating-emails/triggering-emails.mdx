...
description: "Use a Loop when you’d like to trigger an email based on an event that you trigger via our API, Zapier or Segment. You can also use a preset trigger like “User joins list” to trigger a Loop."
---
