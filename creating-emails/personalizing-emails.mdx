...
description: 'Merge tags are a great way to add context and personalization to emails. They allow you to include user attributes such as their first name in your emails. To add a merge tag, simply select the merge tag icon in the toolbar of the email editor. When the email is sent, the first name of the user will be added in the appropriate place.'
---
...
Any user data attributes you sync with the platform either through the [API](/add-users/api-reference) or through [Zapier](/add-users/zapier) you can include as a merge tag in your email to further personalize it.
